...
function initialize_language_strings() {
	...
	arr["RUSSIAN",75]="Спасибо \"Spanish pentesting crew\", за \"Wifislax Staff\", людям с форумов, которые мне помогают, тем, кто принимает участие в проекте, переводчикам и особенно kcdtv, xpz3 и xtonousou за бета тестирование и полученную поддержку"
	...
	arr["RUSSIAN",119]="5.  Меню инструментов для работы с рукопожатием/PMKID"
	...
	arr["RUSSIAN",120]="Меню инструментов для работы с рукопожатием/PMKID"
	...
	arr["RUSSIAN",121]="6.  Захват рукопожатия"
	...
	arr["RUSSIAN",122]="7.  Очистка/оптимизация файла рукопожатия"
	...
	arr["FRENCH",663]="5.  Capture du PMKID"
	arr["CATALAN",663]="5.  Captura PMKID"
	arr["PORTUGUESE",663]="5.  Capturar PMKID"
	arr["RUSSIAN",663]="5.  Захват PMKID"
	arr["GREEK",663]="5.  Σύλληψη PMKID"
	arr["ITALIAN",663]="5.  Catturare PMKID"
	arr["POLISH",663]="5.  Przechwyć PMKID"
	...
	arr["CATALAN",664]="És possible obtenir PMKIDs de xarxes WPA/WPA2-PSK sense clients"
	arr["PORTUGUESE",664]="É possível obter PMKIDs de redes WPA/WPA2-PSK sem clientes"
	...
	arr["FRENCH",665]="Dans les réseaux WPA/WPA2-PSK vous pouvez cracker du PMKIDs ou Handshakes pour obtenir le mot de passe du réseau"
	arr["CATALAN",665]="A les xarxes WPA/WPA2-PSK, pot esquerdar ja sigui PMKIDs o Handshakes per obtenir la contrasenya de xarxa"
	arr["PORTUGUESE",665]="Nas redes WPA/WPA2-PSK, é possível obter a senha de Handshakes ou PMKIDs"
	...
	arr["CATALAN",666]="Si captures un Handshake o PMKID, pots intentar desxifrar al menú de desxifrat WPA/WPA2 offline triant el submenú de tipus \"Personal\""
	...
	arr["CATALAN",667]="S'ha detectat una versió antiga d'aircrack. Cap problema si planeges desxifrar un Handshake, però cal tenir en compte que per desxifrar PMKID es requereix com a mínim la versió \${aircrack_pmkid_version} de aircrack. En cas contrari el PMKID no serà detectat"
	...
	arr["FRENCH",668]="6.  (hashcat) Attaque de dictionnaire en utilisant le fichier de capture PMKID"
	arr["CATALAN",668]="6.  (hashcat) Atac de diccionari sobre fitxer de captura PMKID"
	arr["PORTUGUESE",668]="6.  (hashcat) Ataque com dicionário em um PMKID"
	...
	arr["FRENCH",669]="7.  (hashcat) Attaque de force brute en utilisant le fichier de capture PMKID"
	arr["CATALAN",669]="7.  (hashcat) Atac de força bruta sobre fitxer de captura PMKID"
	arr["PORTUGUESE",669]="7.  (hashcat) Ataque de força bruta em um PMKID"
	...
	arr["FRENCH",670]="8.  (hashcat) Attaque fondé sur des règles en utilisant le fichier de capture PMKID"
	arr["CATALAN",670]="8.  (hashcat) Atac basat en regles sobre el fitxer de captura PMKID"
	arr["PORTUGUESE",670]="8.  (hashcat) Ataque baseado em regras em um arquivo PMKID"
	...
	arr["CATALAN",671]="No tanquis manualment la finestra, el script ho farà quan escaigui. En uns \${timeout} segons com a màxim sabràs si vas aconseguir el PMKID"
	...
	arr["CATALAN",672]="Sembla que no ho hem aconseguit... intenta-ho de nou, tria un altre objectiu o incrementa el timeout. Pot ser que el punt d'accés no sigui vulnerable"
	...
	arr["CATALAN",673]="Fitxer PMKID generat amb èxit a [\${normal_color}\${enteredpath}\${blue_color}]"
	...
	arr["FRENCH",674]="Entrez le chemin où vous voulez enregistrer le fichier ou bien appuyez sur [Enter] pour prendre le chemin proposé par défaut \${normal_color}[\${pmkidpath}]"
	arr["CATALAN",674]="Escriu la ruta on guardarem el fitxer o prem [Enter] per acceptar la proposta per defecte \${normal_color}[\${pmkidpath}]"
	arr["PORTUGUESE",674]="Digite o caminho para salvar o arquivo ou pressione [Enter] para o caminho padrão \${normal_color}[\${pmkidpath}]"
	arr["RUSSIAN",674]="Напечатайте путь, по которому сохранить файл или нажмите [Enter] для принятия предложения по умолчанию \${normal_color}[\${pmkidpath}]"
	arr["GREEK",674]="Πληκτρολογήστε το μονοπάτι για την αποθήκευση του αρχείου ή πατήστε [Enter] για την προεπιλεγμένη επιλογή \${normal_color}[\${pmkidpath}]"
	arr["ITALIAN",674]="Scrivere il percorso dove memorizzare il file o premere [Enter] per accettare la proposta di default \${normal_color}[\${pmkidpath}]"
	...
	arr["CATALAN",675]="El fitxer seleccionat té un format vàlid de hash PMKID per hashcat"
	...
	arr["CATALAN",676]="El fitxer seleccionat no té un format vàlid de hash PMKID per hashcat"
	...
	arr["CATALAN",678]="Tens hashcat instal·lat (v\${hashcat_version}). Compleixes amb el requisit de versió per a realitzar l'atac PMKID integrat amb hashcat (versió mínima v\${minimum_hashcat_pmkid_version}). El script pot continuar..."
